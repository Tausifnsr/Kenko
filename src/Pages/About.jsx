import Filteration from "../AboutPageComponents/Filteration"
  ...
  return (
    <>
        ...
        <div className="text-center flex flex-col translate-y-60">
          <h1 className="heading text-[70px] font-extrabold">About Us</h1>
      ...
      <Quality/>
      <Video videoId="dQw4w9WgXcQ" // YouTube video ID
