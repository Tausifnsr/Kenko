...
function CustomDropdown() {
  ...
  const [selectedOption, setSelectedOption] = useState("Choose a Service");
  ...
  return (
    <div className="relative w-[320px] mt-2" ref={dropdownRef}>
      ...
      >
        <span
          className={`${
            selectedOption === "Choose a Service" ? "text-[#666]" : "text-[#666]"
          } ${selectedOption !== "Choose a Service"} w-full text-center`}
        >
          {selectedOption}
        </span>
