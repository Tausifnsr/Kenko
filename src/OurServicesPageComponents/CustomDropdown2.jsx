...
function CustomDropdown() {
  ...
  const [selectedOption, setSelectedOption] = useState("Type of Service");
  ...
  return (
    <div className="relative w-[320px] mt-2" ref={dropdownRef}>
      ...
      >
        <span
          className={`${
            selectedOption === "Type of Service" ? "text-[#666]" : "text-[#666]"
          } ${selectedOption !== "Type of Service"} w-full text-center`}
        >
          {selectedOption}
        </span>
