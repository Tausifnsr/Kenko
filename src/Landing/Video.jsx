      ...
      <div className="w-[80%] mx-auto">
        <div className="mt-20 rounded-xl">
          {!showVideo ? (
            ...
            <div data-aos="fade-right" className="relative rounded-xl w-[70%] mx-auto">
              <img
                src={thumbnailUrl}
                alt="Video Thumbnail"
        ...
        <div className="flex justify-center gap-x-12 mt-10 mb-20 mx-auto">
          <div data-aos="flip-right" data-aos-delay="600" className="relative overflow-hidden cursor-pointer rounded-xl hover-img-container">
            <img className="h-[250px] hoverImg" src={vidImg1} alt="" />
          </div>

          <div data-aos="flip-right" data-aos-delay="700" className="relative overflow-hidden cursor-pointer rounded-xl hover-img-container">
            <img className="h-[250px] hoverImg" src={vidImg2} alt="" />
          </div>

          <div data-aos="flip-right" data-aos-delay="800" className="relative overflow-hidden cursor-pointer rounded-xl hover-img-container">
