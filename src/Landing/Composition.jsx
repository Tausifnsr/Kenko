  ...
  return (
    <>
      <div className="bg-[#f3f9ff]">
        <div className="pt-20 mx-auto mb-20">
        ...
        <div className="flex w-[80%] justify-between mx-auto">
          ...
          <div className="w-1/3 text-right flex justify-end">
            <div className="flex flex-col">
              <div data-aos="fade-right" data-aos-delay="600" className="flex mb-32">
                <div className="pr-5">
              ...
              <div data-aos="fade-right" data-aos-delay="800" className="flex">
                <div className="pr-5">
                  <h1 className="heading text-[25px] font-semibold">
                    Fluoride
                    <br />
          ...
          <div className="w-1/3">
            <span className="glassRipple relative">
              <img data-aos="fade-up" data-aos-delay="500" className="absolute -top-10" src={Glass} alt="" />
            </span>
          </div>
          ...
          <div className="w-1/3 text-left flex justify-start">
            <div className="flex flex-col">
              <div data-aos="fade-left" data-aos-delay="600" className="flex mb-28">
                <div className="text-[30px] flex chem text-sky-500">
              ...
              <div data-aos="fade-left" data-aos-delay="800" className="flex">
                <div className="text-[30px] flex chem text-sky-500">
                  <img className="ml-10 h-[100px]" src={Drop} alt="" />
                  <p>Mg</p>
                </div>
        ...
        <div className="flex gap-x-2 py-20 w-[60%] mx-auto justify-between cursor-pointer text-center">
          <div data-aos="fade-up" data-aos-delay="200" className="px-5">
          ...
          <div data-aos="fade-up" data-aos-delay="250" className="px-5">
            <h1 className="heading text-[22px] font-bold text-center hover:text-[#F5A93F] transition-hover duration-500 ease-in-out mx-auto">
              Bicarbonates
              <br />
              157 mg/L
          ...
          <img className="h-[50px] my-auto" src={BWave} alt="" />
          <div data-aos="fade-up" data-aos-delay="300" className="px-5">
            <h1 className="heading text-[22px] font-bold text-center hover:text-[#F5A93F] transition-hover duration-500 ease-in-out mx-auto">
              Sulphates
              <br />
              5.6 mg/L
          ...
          <img className="h-[50px] my-auto" src={BWave} alt="" />
          <div data-aos="fade-up" data-aos-delay="350" className="px-5">
            <h1 className="heading text-[22px] font-bold text-center hover:text-[#F5A93F] transition-hover duration-500 ease-in-out mx-auto">
              Sodium
              <br />
              0.4 mg/L
